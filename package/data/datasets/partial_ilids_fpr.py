...
class PartialiLIDsFPR(Dataset):
    """Partial iLIDS used in paper:
    Foreground-aware pyramid reconstruction for alignment-free occluded person re-identification, ICCV 2019.
    """
    has_ps_label = True
    im_root = 'PartialILIDS'
    split_spec = {
